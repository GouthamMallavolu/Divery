...
<div id="loading"></div>
 DIVery<h5><a href="inv_login.jsp">Inventory_Team ?</a></h5>
    <form class="box" action="dlogin" method="post">
        <h1>Login</h1>
        <input type="text" name="name" placeholder="Agent_name" required>
